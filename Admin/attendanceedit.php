                      ...
                      <section class="panel">
						 ...
						 <?php 
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal"  method="post" action="attendanceupdate.php">
                                      <div class="form-group ">
									    
							             <label for="ccomment" class="control-label col-lg-2">Roll Number</label>
                                          <div class="col-lg-10">
                                              
                                              <?php echo $_REQUEST['roll_num']?>
