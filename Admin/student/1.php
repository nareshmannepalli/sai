...
n=/^\w+$/;
if(!n.test(form.Email_id.value)){
alert("username must contain letter,number and underscores");
}
}
</script>
<div class="tab">
...
<div class="form">
<form name="studentcorner" action="loginintopage1.php" method="post" onmouseup="checkform(this)">
<table>
<tr>
<td>Email Id:</td>
