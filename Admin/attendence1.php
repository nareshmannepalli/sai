                              ...
                              <?php 
                                $con=mysql_connect("localhost","root","");
                                 $db=mysql_select_db("zoom4web_studentcorner",$con);
								  ...
								  $_SESSION['sem_faculty']=$_POST['sem_faculty'];
								  $_SESSION['subject']=$_POST['subject'];
                                 if(isset($_POST['submit'])){
                                $select='select * from studentdetails where dept_id="'.$_POST['department'].'" and current_sem="'.$_POST['sem_faculty'].'"';
                               ...
                               <td><?php echo $a++;?></td>
								...
								<td> <input type="hidden"  name="roll_number<?php echo $i;?>" value="<?php echo $fetch['rollno'];?>"></td>
							   <td> <input type="checkbox" name="present<?php echo $i;?>[]" value="present" checked>Present</td>
