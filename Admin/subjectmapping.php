                          ...
                          <header class="panel-heading">
							...
							$db=mysql_select_db("zoom4web_studentcorner",$con);
							 ...
							 ?>
                              ...
                              <div class="form">
                                  <form class="form-validate form-horizontal"  method="post" action="subjectmappinginsert" enctype="multipart/form-data">
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Employee<span class="required">*</span></label>
                                          <div class="col-lg-10">
										  <select name="Employee" class="form-control " id="ccomment" ><?php while($fetch=mysql_fetch_array($query)){?>
                                              <option value="<?php echo $fetch['id']?>"><?php echo $fetch['NameoftheFaculty']?></option>
											  </select>
										  <?php 
										  }
										  ?>
                                       ...
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <select name="currentsem"  class="form-control " id="ccomment"">
