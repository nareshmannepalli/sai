...
<meta charset="utf-8" />
<head>
<title>ZOOM4WEB Login</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<style>
@import url("http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css");
@import url("http://fonts.googleapis.com/css?family=Source+Sans+Pro:400,700");
*{margin:0; padding:0}
body{background:url(worldmap3.png); font-family: 'Source Sans Pro', sans-serif}
.header{
...
<div class="login">
<form name="login" action="loginintopage1.php" method="post">
<ul>
<li>
<span class="un"><i class="fa fa-user"></i></span><input type="text" required name="Email_id" class="text" placeholder="E-Mail ID"/></li>
<li>
...
<li><div class="span"><span class="ch"><input type="checkbox" id="r"> <label for="r">Remember Me</label> </span> <span class="ch"><a href="forgottenform1.php">Forgot Password?</a></span></div></li>
</ul>
</form>
<div class="social">
...
<div class="up"><a href="form.php">Sign Up</a></div>
</div>
</div>
</body>
</html>