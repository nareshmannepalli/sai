...
<div class="login">
<form name="login" action="logintopage.php" method="post">
<ul>
<li>
<span class="un"><i class="fa fa-user"></i></span><input type="text" required name="rollno" class="text" placeholder="Roll NUmber"/></li>
<li>
...
<li><div class="span"><span class="ch"><input type="checkbox" id="r"> <label for="r">Remember Me</label> </span> <span class="ch"><a href="forgottenform.php">Forgot Password?</a></span></div></li>
</ul>
</form>
<div class="social">
