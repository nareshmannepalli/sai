...
$selec="select * from subject_mappings";
                                      ...
                                      <div class="form-group ">
										  ...
										  $a=1;
                                           while($fetch=mysql_fetch_array($query)){
												...
												<input type="hidden" name="roll_no" value="<?php echo $fetch['rollno'];?>">
												<td><a href="marksview.php?id=<?php echo $fetch['stud_id'];?>&roll_num=<?php echo $fetch['rollno'];?>">View</a></td>
												</tr>
									     	  <?php }
										   ?>
											...
											<?php
                                           while($fetchh=mysql_fetch_array($quer)){
		                                         ?>
												 <input type="hidden" name="faculty_name" value="<?php echo $fetchh['faculty_name'];?>">
												 <input type="hidden" name="department" value="<?php echo $fetchh['department'];?>">
												 <input type="hidden" name="sem_faculty" value="<?php echo $fetchh['sem_faculty'];?>">
												<?php }
										   ?> 
