...
<html lang="en">
  <head>
    ...
    <title>Form Component | Karmanta - Bootstrap 3 Responsive Admin Template</title>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu active">
                      ...
                      <ul class="sub">
                          <li><a class="active" href="form_component.html">Form Components</a></li>                          
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal " action="" method="post">
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" name="empid" class="form-control" value="<?php echo $fetch['empid']?>">
                                      </div>
                                  </div>
                                  <div class="form-group">
