                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              ...
                              <div class="form">
                                  <form class="form-validate form-horizontal"  method="post" action="subjectsinsert.php" enctype="multipart/form-data">
                                      <div class="form-group ">
                                          <label for="cname" class="control-label col-lg-2">Subject<span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control" id="cname" name="subject"  type="text"  required />
                                          </div>
                                      </div>
