                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal"  method="post" action="subjectmappinginsert.php">
							...
							$db=mysql_select_db("zoom4web_studentcorner",$con);
							 ...
							 ?>
                                          <label for="ccomment" class="control-label col-lg-2">Emplyoee</label>
                                          <div class="col-lg-10">
                                              <select name="faculty_name"  class="form-control " id="ccomment"">
											  <option value="Select">Select</option>
											  <?php while($fetch=mysql_fetch_array($query)){?>
											 
                                              <option value="<?php echo $fetch['NameoftheFaculty']?>"><?php echo $fetch['NameoftheFaculty']?></option>
                                            <?php } ?>
                                      ...
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Department</label>
                                          <div class="col-lg-10">
                                              <select name="department"  class="form-control " id="ccomment"">
                                              <option value="select">Select</option>
                                      ...
                                      <div class="form-group ">
                                          <label for="ccomment" class="control-label col-lg-2">Sem</label>
                                          <div class="col-lg-10">
                                              <select name="sem_faculty"  class="form-control " id="ccomment"">
                                              <option value="select">Select</option>
							 ...
							 ?>
                                          ...
                                          <div class="col-lg-10">
                                              ...
                                              <select name="subject_faculty"  class="form-control " id="ccomment"">
											  <option value="Select">Select</option>
											  <?php while($fetch=mysql_fetch_array($query)){?>
                                              
											  <option value="<?php echo $fetch['subject']?>"><?php echo $fetch['subject']?></option>
                                            <?php } ?>
