...
$db=mysql_select_db("zoom4web_studentcorner",$con);
	...
	$query=mysql_query($select);
                              ...
                              <tr>
								  ...
								  <td><form name="" action="profile1.php" method="post">
...
$db=mysql_select_db("zoom4web_studentcorner",$con);
	...
	$query=mysql_query($select);
                              ...
                              <tr>
                                  ...
                                  <td>
<form name="" action="profile1.php" method="post">
<input type="hidden" name="id1" value="<?php echo $fetch['id']?>">
<input type="submit" name="submit1" value="View"></form></td>
...
$con=mysql_connect("localhost","root","");
$db=mysql_select_db("zoom4web_studentcorner",$con);
	 $select="select leavetbl.*,faculty.* from leavetbl LEFT JOIN faculty on leavetbl.empid=faculty.id order by leave_apply_date ASC";
	$query=mysql_query($select);
                                 $a=1;
                                 while($fetch=mysql_fetch_array($query)){
                                 ?>
...
<input type="hidden" name="id1" value="<?php echo $fetch['l_id']?>">
<input type="submit" name="submit" value="View"></form></td>
                              </tr>
								 <?php
								 }
                ...
                <div class="col-sm-6">
                      <section class="panel">
                          ...
                          <table class="table table-condensed">
							...
							$con=mysql_connect("localhost","root","");
							$db=mysql_select_db("zoom4web_studentcorner",$con);
							 $select="select suggestion.*,studentdetails.* from suggestion LEFT JOIN studentdetails on suggestion.s_rollno=studentdetails.rollno ORDER BY message_date ASC";
							$query=mysql_query($select);
							$a=1;
                                 while($fetch=mysql_fetch_array($query)){
                                 ?>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="table-responsive">
							...
							$con=mysql_connect("localhost","root","");
							$db=mysql_select_db("zoom4web_studentcorner",$con);
							 $select="select * from uploads ORDER BY date ASC";
							$query=mysql_query($select);
							$a=1;
                                 while($fetch=mysql_fetch_array($query)){
                                 ?>
